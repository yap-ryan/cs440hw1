...
public class TestPawnCaptureAgent extends ChessAgent {
	...
	public TestPawnCaptureAgent(int playerID, String[] args)
	{
		super(playerID);
	...
	{
		Game game = Planner.getPlanner().getGame(state, TestPawnCaptureAgent.timePlayerHasInMS);
